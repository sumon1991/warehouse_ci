...
if (!hasAccess(14,0)) {
    ...
    {
       $this->sma->checkPermissions(18,9);
    ...
    <ul class="dropdown-menu pull-right" role="menu">';
		...
		if(hasAccess(5,9))
        $action .= '<li>' . $detail_link2 . '</li>';
		if(hasAccess(5,9))
        $action .= '<li>' . $detail_link3 . '</li>';
		if(hasAccess(14,58))
    ...
    {
        $this->sma->checkPermissions(14,9);
    ...
    public function stripe_balance()
    {
       /* if (!$this->Owner) {
		...
		$this->sma->checkPermissions(14,9,true);
...
$this->sma->checkPermissions(14,9);
    ...
    {
        //$this->sma->checkPermissions('index');
		$this->sma->checkPermissions(14,7);
...
$this->sma->checkPermissions(14,7);
    ...
    public function add_payment($id = NULL)
    {
		...
		$this->sma->checkPermissions(14,59,true);
