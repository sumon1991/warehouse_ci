...
class Customers extends MY_Controller
{
    ...
    {
        $this->sma->checkPermissions(11,9);
    ...
    { $this->sma->checkPermissions(11,9);
        ...
        $this->datatables
            ...
            ->where('group_name', 'customer');
			 ...
			 $actions .= "<a class=\"tip\" title='" . lang("list_deposits") . "' href='" . site_url('customers/deposits/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-money\"></i></a> ";
			 $actions .= "<a class=\"tip\" title='" . lang("add_deposit") . "' href='" . site_url('customers/add_deposit/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-plus\"></i></a> ";
			 $actions .= "<a class=\"tip\" title='" . lang("list_addresses") . "' href='" . site_url('customers/addresses/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-location-arrow\"></i></a> ";
			 $actions .= "<a class=\"tip\" title='" . lang("list_users") . "' href='" . site_url('customers/users/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-users\"></i></a> ";
			 $actions .= "<a class=\"tip\" title='" . lang("add_user") . "' href='" . site_url('customers/add_user/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-user-plus\"></i></a> ";
			 $actions .= "<a class=\"tip\" title='" . lang("edit_customer") . "' href='" . site_url('customers/edit/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-edit\"></i></a> ";
			 $actions .= "<a href='#' class='tip po' title='<b>" . lang("delete_customer") . "</b>' data-content=\"<p>" . lang('r_u_sure') . "</p><a class='btn btn-danger po-delete' href='" . site_url('customers/delete/$1') . "'>" . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash-o\"></i></a>";
			 $actions .= "</div>";
			 $actions .= "<div class=\"text-center\"><a href='".site_url("customers/account/$1")."'>".lang("access_account")."</a></div>";
    ...
    { $this->sma->checkPermissions(11,9,true);
 ...
 $this->sma->checkPermissions(11,6,true);
    ...
    {
        //$this->sma->checkPermissions(false, true);
 $this->sma->checkPermissions(11,7,true);
 ...
 $this->sma->checkPermissions(11,7,true);
    ...
    function import_csv()
    {
       // $this->sma->checkPermissions();
		$this->sma->checkPermissions(11,23);
 ...
 $this->sma->checkPermissions(11,8);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
    ...
    {
		 $this->sma->checkPermissions(11,55);
        // $this->sma->checkPermissions('index');
...
*/
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
					if($this->input->post('form_action') == 'export_pdf') $this->sma->checkPermissions(11,20);
					if($this->input->post('form_action') == 'export_excel') $this->sma->checkPermissions(11,21);
    ...
    {
        //$this->sma->checkPermissions(false, true);
$this->sma->checkPermissions(35,9);
        if ($this->input->get('id')) {
            $company_id = $this->input->get('id');
        }
    ...
    {
		$this->sma->checkPermissions(35,6);
    ...
    {
       // $this->sma->checkPermissions('deposits', true);
$this->sma->checkPermissions(35,7,true);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
    ...
    {
       // $this->sma->checkPermissions(NULL, TRUE);
$this->sma->checkPermissions(35,8,true);
    ...
    {
      //  $this->sma->checkPermissions('deposits', true);
		$this->sma->checkPermissions(35,9,true);
        $deposit = $this->companies_model->getDepositByID($id);
    ...
    {
        //$this->sma->checkPermissions('index', true);
		$this->sma->checkPermissions(34,9,true);
        $this->data['modal_js'] = $this->site->modal_js();
        $this->data['company'] = $this->companies_model->getCompanyByID($company_id);
    ...
    function add_address($company_id = NULL)
    {
		...
		$this->sma->checkPermissions(34,6,true);
        $company = $this->companies_model->getCompanyByID($company_id);
	...
	$this->sma->checkPermissions(34,7,true);
        $this->form_validation->set_rules('line1', lang("line1"), 'required');
        $this->form_validation->set_rules('city', lang("city"), 'required');
        $this->form_validation->set_rules('state', lang("state"), 'required');
        $this->form_validation->set_rules('country', lang("country"), 'required');
	...
	$this->sma->checkPermissions(34,8,true);
	...
	{
		$this->sma->checkPermissions(11,65);
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
		$this->data['customer'] = $this->companies_model->getCompanyByID($id);
        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => '#', 'page' => lang('customer account')));
        $meta = array('page_title' => lang('customer account'), 'bc' => $bc);
        $this->page_construct('customers/account', $meta, $this->data);
	}
