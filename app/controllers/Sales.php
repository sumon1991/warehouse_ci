...
$this->sma->checkPermissions(5,9);
        ...
        <ul class="dropdown-menu pull-right" role="menu">';
			...
			if(hasAccess(5,59))
            $action .= '<li>' . $add_payment_link . '</li>';
			if(hasAccess(5,7))
            $action .= '<li>' . $add_delivery_link . '</li>';
			if(hasAccess(5,7))
...
$this->sma->checkPermissions(5,9,true);
...
$this->sma->checkPermissions(5,11);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
...
$this->sma->checkPermissions(5,22);
...
$this->sma->checkPermissions(5,10,true);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
        $inv = $this->sales_model->getInvoiceByID($id);
...
$this->sma->checkPermissions(5,61);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
...
$this->sma->checkPermissions(5,8,true);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
...
if($this->input->post('form_action') == 'export_pdf') $this->sma->checkPermissions(5,20);
if($this->input->post('form_action') == 'export_excel') $this->sma->checkPermissions(5,21);
...
$this->sma->checkPermissions(6,9);
    ...
    {
       // $this->sma->checkPermissions();
$this->sma->checkPermissions(6,11);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
        $this->data['error'] = (validation_errors() ? validation_errors() : $this->session->flashdata('error'));
...
if($this->input->post('form_action') == 'export_pdf') $this->sma->checkPermissions(6,20);
if($this->input->post('form_action') == 'export_excel') $this->sma->checkPermissions(6,21);
    ...
    {
      //  $this->sma->checkPermissions(false, true);
		$this->sma->checkPermissions(5,58,true);
    ...
    public function add_payment($id = null)
    {
       // $this->sma->checkPermissions('payments', true);
		...
		$this->sma->checkPermissions(5,59,true);
    ...
    public function edit_payment($id = null)
    {
		...
		$this->sma->checkPermissions(5,62,true);
        $this->load->helper('security');
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
    ...
    {
       // $this->sma->checkPermissions('delete');
$this->sma->checkPermissions(5,60);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
        ...
        if ($rows) {
            foreach ($rows as $row) {
                ...
                if ($row->promotion) {
                    ...
                    $pr_group_price = $this->site->getProductGroupPrice($row->id, $customer->price_group_id);
                    $row->price = $pr_group_price->price;
                } elseif ($warehouse->price_group_id) {
                    $pr_group_price = $this->site->getProductGroupPrice($row->id, $warehouse->price_group_id);
                    $row->price = $pr_group_price->price;
                }
...
$this->sma->checkPermissions(7,9);
        ...
        $this->datatables
			...
			if(hasAccess(7,9))
			$actions .= "<a href='" . site_url('sales/view_gift_card/$1') . "' class='tip' title='" . lang("view_gift_card") . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-eye\"></i></a> ";
			if(hasAccess(7,9))
			$actions .= "<a href='" . site_url('sales/topup_gift_card/$1') . "' class='tip' title='" . lang("topup_gift_card") . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-dollar\"></i></a> ";
			if(hasAccess(7,7))
			$actions .= "<a href='" . site_url('sales/edit_gift_card/$1') . "' class='tip' title='" . lang("edit_gift_card") . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-edit\"></i></a> ";
			if(hasAccess(7,8))
			$actions .= "<a href='#' class='tip po' title='<b>" . lang("delete_gift_card") . "</b>' data-content=\"<p>" . lang('r_u_sure') . "</p><a class='btn btn-danger po-delete' href='" . site_url('sales/delete_gift_card/$1') . "'>" . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash-o\"></i></a>";
			$actions .= "</div>";
    ...
    public function topup_gift_card($card_id)
    {
       // $this->sma->checkPermissions('add_gift_card', true);
		$this->sma->checkPermissions(7,6,true);
...
$this->sma->checkPermissions(7,6,true);
    ...
    {
       // $this->sma->checkPermissions(false, true);
$this->sma->checkPermissions(7,7,true);
...
if($this->input->post('form_action') == 'export_pdf') $this->sma->checkPermissions(7,20);
if($this->input->post('form_action') == 'export_excel') $this->sma->checkPermissions(7,21);
...
$this->sma->checkPermissions(7,9);
    ...
    public function sale_by_csv()
    {
       // $this->sma->checkPermissions('csv');
		$this->sma->checkPermissions(5,23);
        $this->load->helper('security');
