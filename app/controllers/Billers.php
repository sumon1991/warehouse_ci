...
class Billers extends MY_Controller
{
    ...
    function add()
    {
	   ...
	   $this->sma->checkPermissions(18,6,true);
    ...
    {
        //$this->sma->checkPermissions(false, true);
$this->sma->checkPermissions(18,7,true);
...
$this->sma->checkPermissions(18,8,true);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
    ...
    {
       // $this->sma->checkPermissions('index');
$this->sma->checkPermissions(18,55);
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                if ($this->input->post('form_action') == 'delete') {
					$this->sma->checkPermissions(18,8);
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
					if($this->input->post('form_action') == 'export_pdf') $this->sma->checkPermissions(18,20);
					if($this->input->post('form_action') == 'export_excel') $this->sma->checkPermissions(18,21);
