...
class Transfers extends MY_Controller
{
    ...
    function index()
    {
        $this->sma->checkPermissions(10,9);
		//hasAccess(10,0);
    ...
    {
        $this->sma->checkPermissions(10,9,true);
        ...
        if(hasAccess(10,24) && !hasAccess(10,25)) {
    ...
    function add()
    {
        $this->sma->checkPermissions(10,6);
    ...
    {
        $this->sma->checkPermissions(10,7);
    ...
    {
        $this->sma->checkPermissions(10,23);
    ...
    {
		$this->sma->checkPermissions(10,11);
    ...
    {
        $this->sma->checkPermissions(10,22);
    ...
    {
        $this->sma->checkPermissions(10,10, true);
    ...
    {
        $this->sma->checkPermissions(10,8, TRUE);
    ...
    {
        $this->sma->checkPermissions(10,55, TRUE);
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                if ($this->input->post('form_action') == 'delete') {
					$this->sma->checkPermissions(10,8);
...
if($this->input->post('form_action') == 'export_excel') $this->sma->checkPermissions(10,21);
if($this->input->post('form_action') == 'export_pdf') $this->sma->checkPermissions(10,20);
