...
$this->sma->checkPermissions(9,9,true);
...
$this->sma->checkPermissions(9,11);
        if ($this->input->get('id')) {
            $purchase_id = $this->input->get('id');
        }
...
$this->sma->checkPermissions(9,22);
...
$this->sma->checkPermissions(9,10,true);
        if ($this->input->get('id')) {
            $purchase_id = $this->input->get('id');
        }
        $inv = $this->purchases_model->getPurchaseByID($purchase_id);
...
$this->sma->checkPermissions(9,7);
    ...
    public function purchase_by_csv()
    {
		...
		$this->sma->checkPermissions(9,23);
...
$this->sma->checkPermissions(9,7,true);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
    ...
    {
        //$this->sma->checkPermissions(false, true);
$this->sma->checkPermissions(9,58);
    ...
    public function payment_note($id = null)
    {
		...
		$this->sma->checkPermissions(9,58,true);
    ...
    {
        //$this->sma->checkPermissions('payments', true);
		$this->sma->checkPermissions(9,59,true);
        $this->load->helper('security');
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
    ...
    public function edit_payment($id = null)
    {
		...
		$this->sma->checkPermissions(9,62,true);
        $this->load->helper('security');
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
...
$this->sma->checkPermissions(9,60,true);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
    ...
    {
       // $this->sma->checkPermissions();
$this->sma->checkPermissions(15,9);
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
...
$this->sma->checkPermissions(15,9);
    ...
    public function add_expense()
    {
		...
		$this->sma->checkPermissions(15,6,true);
        $this->load->helper('security');
    ...
    {
       // $this->sma->checkPermissions('edit', true);
		$this->sma->checkPermissions(15,7,true);
        $this->load->helper('security');
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
    ...
    {
      //  $this->sma->checkPermissions('delete', true);
$this->sma->checkPermissions(15,8,true);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
        $expense = $this->purchases_model->getExpenseByID($id);
    ...
    public function expense_actions()
    {
       /* if (!$this->Owner && !$this->GP['bulk_actions']) {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                if ($this->input->post('form_action') == 'delete') {
					$this->sma->checkPermissions(15,8);
                    //$this->sma->checkPermissions('delete');
                    foreach ($_POST['val'] as $id) {
...
if($this->input->post('form_action') == 'export_pdf') $this->sma->checkPermissions(15,20);
if($this->input->post('form_action') == 'export_excel') $this->sma->checkPermissions(15,21);
...
$this->sma->checkPermissions(15,61);
        if ($this->input->get('id')) {
            $id = $this->input->get('id');
        }
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
