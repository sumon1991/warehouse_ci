...
class Sma
{
    ...
    public function checkPermissions($module = null, $rule = null, $js = null)
    {
	
        if (!$this->actionPermissions($module, $rule)) {
    ...
    public function actionPermissions($module = null,$rule = null)
    {
		//echo 'Test: '.$module;exit;
		return TRUE;
		/*if(!$module || !$rule) {
			return TRUE;
		}
