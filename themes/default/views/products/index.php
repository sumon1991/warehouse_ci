    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
			    ...
			    "aoColumns": [
                {"bSortable": false, "mRender": checkbox}, {"bSortable": false,"mRender": img_hl}, null, null, null, null, <?php echo '{"mRender": currencyFormat}, {"mRender": currencyFormat},'; if($this->session->userdata('show_price')) { echo '{"mRender": currencyFormat},';  }  ?> {"mRender": formatQuantity}, null, <?php if(!$warehouse_id || !$Settings->racks) { echo '{"bVisible": false},'; } else { echo '{"bSortable": true},'; } ?> {"mRender": formatQuantity}, {"bSortable": false}
            ]
        /*    "aoColumns": [
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <?php if(hasAccess(4,6)) {?>
                        ...
                        <?php if(hasAccess(4,21)) {?>
                        <li>
                            <a href="#" id="excel" data-action="export_excel">
                                <i class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?>
                            </a>
                        </li> <?php } ?>
                        <?php if(hasAccess(4,20)) {?>
                        <li>
                            <a href="#" id="pdf" data-action="export_pdf">
                                <i class="fa fa-file-pdf-o"></i> <?= lang('export_to_pdf') ?>
                            </a>
                        </li> <?php } ?>
                        <?php if(hasAccess(4,8)) {?>
                        <li class="divider"></li>
                        <li>
