                ...
                <li class="dropdown">
                    ...
                    <?php if(hasAccess(18,6)) {?>
                        <li><a href="<?= site_url('billers/add'); ?>" data-toggle="modal" data-target="#myModal"
                               id="add"><i class="fa fa-plus-circle"></i> <?= lang("add_biller"); ?></a></li><?php }?>
                         <?php if(hasAccess(18,21)) {?> <li><a href="#" id="excel" data-action="export_excel"><i
                                    class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li><?php }?>
                        <?php if(hasAccess(18,20)) {?>  <li><a href="#" id="pdf" data-action="export_pdf"><i
                                    class="fa fa-file-pdf-o"></i> <?= lang('export_to_pdf') ?></a></li><?php }?>
                        <?php if(hasAccess(18,8)) {?>
                        <li class="divider"></li>
                        <li><a href="#" class="bpo" title="<b><?= $this->lang->line("delete_billers") ?></b>"
                               ...
                               data-html="true" data-placement="left"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_billers') ?></a></li><?php }?>
                    </ul>
                </li>
            </ul>
        </div>
