        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <?php if(hasAccess(6,21)) {?>
                        <li><a href="#" id="excel" data-action="export_excel"><i class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li><?php }?>
                        <?php if(hasAccess(6,20)) {?>
                        <li><a href="#" id="pdf" data-action="export_pdf"><i class="fa fa-file-pdf-o"></i> <?= lang('export_to_pdf') ?></a></li><?php }?>
                        <?php if(hasAccess(6,8)) {?>
                        <li class="divider"></li>
                        <li>
