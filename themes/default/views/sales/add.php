...
<script type="text/javascript">
    var count = 1, an = 1, product_variant = 0, DT = <?= $Settings->default_tax_rate ?>,
        product_tax = 0, invoice_tax = 0, product_discount = 0, order_discount = 0, total_discount = 0, total = 0, allow_discount = <?= ($this->session->userdata('allow_discount')) ? 1 : 0; ?><? //= ($Owner || $Admin || $this->session->userdata('allow_discount')) ? 1 : 0; ?>,
                ...
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <table id="slTable"
                                        ...
                                        <tr>
                                         ...
                                         //   if ($Settings->product_discount && ($Owner || $Admin || $this->session->userdata('allow_discount'))) {
											   if ($Settings->product_discount && ($this->session->userdata('allow_discount'))) {
                        ...
                        <?php //if ($Owner || $Admin || $this->session->userdata('allow_discount')) { ?>
                          <?php if ($this->session->userdata('allow_discount')) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <?php if ($Settings->product_discount && ($this->session->userdata('allow_discount'))) { ?>
                        <div class="form-group">
                            <label for="pdiscount"
