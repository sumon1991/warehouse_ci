...
<div class="row" style="margin-bottom: 15px;">
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-content">
            <?php if(hasAccess(4,0) && hasAccess(4,9)) { ?>
                ...
                <?php if(hasAccess(5,0) && hasAccess(5,9)) { ?>
                <div class="col-lg-1 col-md-2 col-xs-6">
 ...
 <?php if(hasAccess(8,0) && hasAccess(8,9)) { ?>
                <div class="col-lg-1 col-md-2 col-xs-6">
 ...
 <?php if(hasAccess(9,0) && hasAccess(9,9)) { ?>
                <div class="col-lg-1 col-md-2 col-xs-6">
 ...
 <?php if(hasAccess(10,0) && hasAccess(10,9)) { ?>
                <div class="col-lg-1 col-md-2 col-xs-6">
 ...
 <?php if(hasAccess(11,0) && hasAccess(11,9)) { ?>
                <div class="col-lg-1 col-md-2 col-xs-6">
 ...
 <?php if(hasAccess(12,0) && hasAccess(12,9)) { ?>
                <div class="col-lg-1 col-md-2 col-xs-6">
 ...
 <?php if(hasAccess(17,0) && hasAccess(17,9)) { ?>
                <div class="col-lg-1 col-md-2 col-xs-6">
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php if(hasAccess(5,0) && hasAccess(5,9)) { ?>
                            <li class=""><a href="#sales"><?= lang('sales') ?></a></li><?php }?>
                            <?php if(hasAccess(8,0) && hasAccess(8,9)) { ?>
                            <li class=""><a href="#quotes"><?= lang('quotes') ?></a></li><?php }?>
                            <?php if(hasAccess(9,0) && hasAccess(9,9)) { ?>
                            <li class=""><a href="#purchases"><?= lang('purchases') ?></a></li><?php }?>
                            <?php if(hasAccess(10,0) && hasAccess(10,9)) { ?>
                            <li class=""><a href="#transfers"><?= lang('transfers') ?></a></li><?php }?>
                            <?php if(hasAccess(11,0) && hasAccess(11,9)) { ?>
                            <li class=""><a href="#customers"><?= lang('customers') ?></a></li><?php }?>
                            <?php if(hasAccess(12,0) && hasAccess(12,9)) { ?>
                            <li class=""><a href="#suppliers"><?= lang('suppliers') ?></a></li><?php }?>
                        </ul>
