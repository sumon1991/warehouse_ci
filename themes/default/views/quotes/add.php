...
<script type="text/javascript">
    var count = 1, an = 1, product_variant = 0, DT = <?= $Settings->default_tax_rate ?>, allow_discount = <?= ($this->session->userdata('allow_discount')) ? 1 : 0; ?><? //= ($Owner || $Admin || $this->session->userdata('allow_discount')) ? 1 : 0; ?>,
