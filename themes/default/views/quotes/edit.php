...
<script type="text/javascript">
    var count = 1, an = 1, DT = <?= $Settings->default_tax_rate ?>, allow_discount = <?= ($this->session->userdata('allow_discount')) ? 1 : 0; ?><? //= ($Owner || $Admin || $this->session->userdata('allow_discount')) ? 1 : 0; ?>,
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if (($this->session->userdata('allow_discount')) || $inv->order_discount_id) { ?>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php //echo form_input('discount', '', 'class="form-control input-tip" id="qudiscount" '.(($Owner || $Admin || $this->session->userdata('allow_discount')) ? '' : 'readonly="true"')); ?>
                                      <?php echo form_input('discount', '', 'class="form-control input-tip" id="qudiscount" '.(($this->session->userdata('allow_discount')) ? '' : 'readonly="true"')); ?>
                            </div>
                        </div>
                        <?php } ?>
                    ...
                    <!--    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php //if ($GP['suppliers-add'] || $GP['suppliers-index']) { ?><div class="input-group"><?php //} ?>
                                    ...
                                    <table id="quTable"
                                        ...
                                        <tr>
                                         ...
                                         //   if ($Settings->product_discount && ($Owner || $Admin || $this->session->userdata('allow_discount') || $inv->product_discount)) {
											    if ($Settings->product_discount && ($this->session->userdata('allow_discount') || $inv->product_discount)) {
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <?php if ($Settings->product_discount) { ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="pdiscount" <?= ($this->session->userdata('allow_discount')) ? '' : 'readonly="true"'; ?><? //= ($Owner || $Admin || $this->session->userdata('allow_discount')) ? '' : 'readonly="true"'; ?>>
                            </div>
                        </div>
                    <?php } ?>
                    <div class="form-group">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <?php if ($Settings->product_discount) { ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mdiscount" <?= ($this->session->userdata('allow_discount')) ? '' : 'readonly="true"'; ?><? //= ($Owner || $Admin || $this->session->userdata('allow_discount')) ? '' : 'readonly="true"'; ?>>
                            </div>
                        </div>
                    <?php } ?>
                    <div class="form-group">
