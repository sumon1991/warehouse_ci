         ...
         <?php if(hasAccess(20,27)) { ?>
          ...
          <li id="system_settings_email_templates"> <a href="<?= site_url('system_settings/email_templates') ?>"> <i class="fa fa-envelope"></i><span class="text">
            <?= lang('email_templates'); ?>
             ...
             <?php if(hasAccess(37,0) && hasAccess(37,9)) { ?>
          <li id="system_settings_warehouses"> <a href="<?= site_url('system_settings/translations') ?>"> <i class="fa fa-building-o"></i><span class="text">
            <?= lang('translations'); ?>
            </span> </a> </li><?php } ?>
            
       
        <?php if(hasAccess(20,31)) { ?>
