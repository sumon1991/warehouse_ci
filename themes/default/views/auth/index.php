                ...
                <li class="dropdown">
                    ...
                    <?php if(hasAccess(17,6)) {?>
                        <li><a href="<?= site_url('auth/create_user'); ?>"><i
                                    class="fa fa-plus-circle"></i> <?= lang("add_user"); ?></a></li><?php }?>
                        <?php if(hasAccess(17,21)) {?> <li><a href="#" id="excel" data-action="export_excel"><i
                                    class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li><?php }?>
                         <?php if(hasAccess(17,20)) {?><li><a href="#" id="pdf" data-action="export_pdf"><i
                                    class="fa fa-file-pdf-o"></i> <?= lang('export_to_pdf') ?></a></li><?php }?>
                                    
                                    
                        <?php if(hasAccess(17,67)) {?><li><a href="<?= site_url('auth/view_tree/'.$this->loginID); ?>"><i
                                    class="fa fa-sitemap"></i> <?= lang('view_my_tree') ?></a></li><?php }?>
                                    
                        <?php if(hasAccess(17,8)) {?> <li class="divider"></li>
                        <li><a href="#" class="bpo" title="<b><?= $this->lang->line("delete_users") ?></b>"
                               ...
                               data-html="true" data-placement="left"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_users') ?></a></li><?php }?>
                    </ul>
                </li>
            </ul>
        </div>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-1"><?php echo lang('created_by'); ?></th>
