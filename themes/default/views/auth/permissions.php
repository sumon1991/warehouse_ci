        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php if (!empty($privileges)) {
                    //if ($p->group_id != 1) {
                        echo form_open("auth/permissions/" . $id); 
						?>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <th width="75%"><?= lang("permissions"); ?></th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <input type="checkbox" id="CheckAllRow-<?php echo $privilege['id']; ?>" class="CheckAllRow" value="" />
                                     ...
                                     <td class="text-center">
                                       <?php 
										   $cl = "";
										   if(groupHasAccess($privilege['id'],enableDisableID(),$id))
										   $cl = 'checked="checked"';
										   ?>
                                    ...
                                    <td>
                                       <?php foreach($privilege['rules'] as $rul) {
										   $cl = "";
										   if(groupHasAccess($privilege['id'],$rul['id'],$id))
										   $cl = 'checked="checked"';
