...
$(document).ready(function() {
	...
	$('.RowClickEvent .iCheck-helper').click(function(){
		var InputParent = $(this).parent("div");
		var InputClass = InputParent.find('.CheckAllRow');
		var id = parseInt(InputClass.attr("id").replace('CheckAllRow-',''));
		$(".CheckAllRow-"+id).each(function(){
			if(InputParent.hasClass("checked")) {
				$(this).parent("div.icheckbox_square-blue").addClass("checked");
				$(this).prop("checked", true);
			}
			else {
				$(this).parent("div.icheckbox_square-blue").removeClass("checked");
				$(this).prop("checked", "");
			}
		});
	});
	...
	$('.CheckAll .iCheck-helper').click(function(){
		var InputParent = $(this).parent("div");
		var InputClass = InputParent.find('input[type="checkbox"]');
		var id = parseInt(InputClass.attr("id").replace('CheckAllRow-',''));
